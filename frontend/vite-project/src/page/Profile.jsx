    ...
    const handleSubmit = async () => {
        if (inputs.username && inputs.bio && inputs.fullName && inputFile) {
            ...
            try {
                ...
                const result = await axios.put(`${context.env.REACT_APP_BACKEND_HOST}/user/EditProfile/`, fileUpload)
    ...
    if (loading) {
        ...
        return (
            ...
            `}>
                    ...
                    <button onClick={editProfile} className='text-red-600  top-[10px] right-[50px] absolute'>
                        <i className="text-[32px] fa-solid fa-xmark"></i>
                    </button>
                    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto  lg:py-0">
                        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                ...
                                <button onClick={handleSubmit} type="submit" className="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Edit Profile</button>
